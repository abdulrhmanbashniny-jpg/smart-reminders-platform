...
insert into public.system_settings (id, company_name_ar, company_name_en, platform_name_ar, platform_name_en)
values (1, 'مصنع جدة للدهانات والمعاجين', 'Jeddah Paint Factory', 'منصة التذكيرات الذكية', 'Smart Reminders Platform')
